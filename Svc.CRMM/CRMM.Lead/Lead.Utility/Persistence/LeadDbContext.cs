...
public sealed class LeadDbContext : DbContext, ILeadDbContext
{
    ...
    public DbSet<LeadIndustryEntity> LeadIndustries => Set<LeadIndustryEntity>();
    public DbSet<LeadScoringRuleEntity> LeadScoringRules => Set<LeadScoringRuleEntity>();
    public DbSet<LeadRoutingRuleEntity> LeadRoutingRules => Set<LeadRoutingRuleEntity>();
    public DbSet<LeadRoutingRuleConditionEntity> LeadRoutingRuleConditions => Set<LeadRoutingRuleConditionEntity>();
